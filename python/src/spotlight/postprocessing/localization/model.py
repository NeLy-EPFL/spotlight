...
Distinct from `spotlight.postprocessing.pose2d`'s RepVGG-A0 model,
...
(~460px, measured from pose2d's own canonical aligned points).
...
from spotlight.postprocessing.localization.constants import N_KEYPOINTS
...
class TinyLocalizationModel(nn.Module):
