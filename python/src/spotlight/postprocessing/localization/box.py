...
visualization (see `scripts/postprocessing/model_training/localization/visualize_predictions.py`)
...
aligned-domain predictions (`spotlight.postprocessing.pose2d`),
...
from spotlight.postprocessing.localization.dataset import (
