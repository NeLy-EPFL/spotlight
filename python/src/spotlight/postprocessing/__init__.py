"""
spotlight.postprocessing: full offline processing pipeline for recordings
...
lighter `spotlight` (calibration, arena registration) doesn't depend
...
replay
    FlyGym (CPU physics) replay of the solved IK joint angles, for the QA
    video's own replay panel.
"""
...
try:
    ...
    raise ImportError(
        'spotlight.postprocessing requires the "postprocessing" extra '
