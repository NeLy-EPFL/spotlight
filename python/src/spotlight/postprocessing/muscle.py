...
spotlight.calibration stage-position mappers.
...
from spotlight.calibration import HomographyMapper
...
# Onset threshold for structure-based leading-orphan detection, used by
# `_count_leading_orphan_muscle_frames`/`_diff_spatial_autocorrelation` below.
