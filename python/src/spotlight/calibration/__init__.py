"""
spotlight.calibration: legacy ArUco-based calibration (still used by postprocessing).
...
For the current arena registration workflow, use spotlight.arena instead.
"""
