...
`spotlight_postprocessing.spotlight_pose2d`) rather than any hand labels.
...
from spotlight_postprocessing.spotlight_orient.augment import augment
from spotlight_postprocessing.spotlight_orient.flip_label import (
    is_flipped,
    valid_frames,
    weighted_confidence,
)
