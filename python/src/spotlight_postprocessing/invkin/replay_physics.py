...
`physics_replay.h5` (see `invkin.replay_io`'s module docstring), for the QA
...
See `invkin.flygym_replay`'s own module docstring for what "replay" means
...
from spotlight_postprocessing.invkin.qa_clips import find_ik_runs
...
from spotlight_postprocessing.visualize import PANEL_SIZE
