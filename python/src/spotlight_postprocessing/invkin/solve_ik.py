...
stretches are good enough for, e.g., FlyGym snippet selection" now happens
downstream in poseforge2, using this file's own per-frame confidence/
mismatch data, not a pre-baked accept/reject decision made here.
...
from spotlight_postprocessing.invkin.calibration import (
    convert_mm_to_px,
    convert_px_to_mm,
...
from spotlight_postprocessing.invkin.neuromechfly import (
    NEUTRAL_WEIGHT,
    BodyPlan,
...
from spotlight_postprocessing.localization.flip_label import weighted_confidence
