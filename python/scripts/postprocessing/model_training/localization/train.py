...
def main(
    ...
    Args:
        train_h5_paths: Training trials' `final_predictions.h5` files (see
            `scripts/postprocessing/model_training/pose2d/run_inference_final.sh`).
        val_h5_paths: Validation trials' `final_predictions.h5` files.
        checkpoint_dir: Where to save checkpoints.
        frame_cache_root: Root directory
            `scripts/postprocessing/model_training/localization/cache_fullsize_frames.py` wrote into;
