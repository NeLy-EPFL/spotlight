#!/bin/bash -l
# Runs v11's TinyLocalizationModel checkpoint over one full validation trial
...
CHECKPOINT_PATH_REL="bulk_data/motion_prior/localization_model/checkpoints/v11/best.pt"
KEYPOINT_SET=neck
VIZ_CRF=23
MAX_VIZ_FRAMES=3000
...
predictions_h5="$output_dir/${TRIAL_STEM}_localization_predictions_v11.h5"
viz_path="$output_dir/${TRIAL_STEM}_localization_viz_v11.mp4"
