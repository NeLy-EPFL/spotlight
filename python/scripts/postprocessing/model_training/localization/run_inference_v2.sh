#!/bin/bash -l
# Runs v2's TinyLocalizationModel checkpoint over one full validation trial
...
CHECKPOINT_PATH_REL="bulk_data/motion_prior/localization_model/checkpoints/v2/best.pt"
VIZ_CRF=23
MAX_VIZ_FRAMES=3000
...
predictions_h5="$output_dir/${TRIAL_STEM}_localization_predictions_v2.h5"
viz_path="$output_dir/${TRIAL_STEM}_localization_viz_v2.mp4"
