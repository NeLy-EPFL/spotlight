#!/bin/bash -l
# Seventh training round for the TinyLocalizationModel, keypoint-only again:
...
checkpoint_dir="$repo_root/bulk_data/motion_prior/localization_model/checkpoints/v7"
