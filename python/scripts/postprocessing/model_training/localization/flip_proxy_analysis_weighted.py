...
Usage:
    python scripts/postprocessing/model_training/localization/flip_proxy_analysis_weighted.py
"""
...
OUTPUT_DIR = (
    REPO_ROOT / "bulk_data/motion_prior/localization_model/flip_proxy_analysis_weighted"
)
N_BINS = 100
