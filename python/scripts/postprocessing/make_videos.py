...
colors as `visualize_predictions.py` (see `pose2d.viz`), the
...
Usage:
    python scripts/postprocessing/make_videos.py \\
...
from spotlight_postprocessing.pose2d.io_utils import load_skeleton_json
...
def main(
    ...
    Args:
        input_path: `solve_ik.py` output `kinematics.h5` (see
            `invkin.io_utils.save_kinematics_h5`). Must have an
    ...
    for start, end in runs:
        ...
        render_run_clip(
            ...
            pred_2d_px=data["keypoint_positions_2d_px"],
