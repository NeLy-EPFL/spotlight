#!/bin/bash -l
# Twelfth training round for the TinyOrientModel: identical setup to v11
...
# and validation: scripts/spotlight_orient/flip_proxy_analysis_weighted.py.
...
checkpoint_dir="$repo_root/bulk_data/motion_prior/orient_model/checkpoints/v12"
