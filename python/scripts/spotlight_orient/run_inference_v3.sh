#!/bin/bash -l
# Runs v3's TinyOrientModel checkpoint over one full validation trial
...
CHECKPOINT_PATH_REL="bulk_data/motion_prior/orient_model/checkpoints/v3/best.pt"
VIZ_CRF=23
MAX_VIZ_FRAMES=3000
...
predictions_h5="$output_dir/${TRIAL_STEM}_orient_predictions_v3.h5"
viz_path="$output_dir/${TRIAL_STEM}_orient_viz_v3.mp4"
