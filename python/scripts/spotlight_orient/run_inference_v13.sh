#!/bin/bash -l
# Runs v13's TinyOrientModel checkpoint over the same 4 trials used for
...
CHECKPOINT_PATH_REL="bulk_data/motion_prior/orient_model/checkpoints/v13/best.pt"
VIZ_CRF=23
MAX_VIZ_FRAMES=3000
...
for trial_stem in "${TRIAL_STEMS[@]}"; do
    predictions_h5="$output_dir/${trial_stem}_orient_predictions_v13.h5"
    viz_path="$output_dir/${trial_stem}_orient_viz_v13.mp4"
