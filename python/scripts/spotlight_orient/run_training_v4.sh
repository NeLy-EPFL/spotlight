#!/bin/bash -l
# Fourth training round for the TinyOrientModel, keypoint-only again: same
...
# spotlight_pose2d.dataset.points_to_heatmaps). This directly supervises
...
checkpoint_dir="$repo_root/bulk_data/motion_prior/orient_model/checkpoints/v4"
