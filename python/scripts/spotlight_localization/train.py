...
Usage:
    python scripts/spotlight_localization/train.py \\
        ...
        --checkpoint-dir bulk_data/motion_prior/localization_model/checkpoints/v1 \\
...
from spotlight_postprocessing.spotlight_localization.model import (
...
def seed_worker(_worker_id: int) -> None:
    """Reseeds a `DataLoader` worker's `TinyLocalizationDataset.rng`.
...
def make_loader(
    ...
    dataset = TinyLocalizationDataset(
        h5_paths,
        frame_cache_root,
        train,
