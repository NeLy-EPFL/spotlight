...
`spotlight_postprocessing.spotlight_localization.dataset.OUTPUT_SIZE`) as JPEG.
...
Usage:
    python scripts/spotlight_localization/cache_fullsize_frames.py
"""
...
CACHE_ROOT = REPO_ROOT / "bulk_data/motion_prior/localization_model/frame_cache"
