#!/bin/bash -l
# Eleventh training round for the TinyLocalizationModel: fixes v10's real
...
checkpoint_dir="$repo_root/bulk_data/motion_prior/localization_model/checkpoints/v11"
