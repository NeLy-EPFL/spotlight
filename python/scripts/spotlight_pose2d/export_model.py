...
from spotlight_postprocessing.spotlight_pose2d.dataset import INPUT_SIZE
from spotlight_postprocessing.spotlight_pose2d.model import RepVGGPoseModel, import_timm
