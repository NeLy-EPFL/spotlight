"""Training-time augmentation for `TinyOrientDataset`: independent
horizontal and vertical flips plus brightness/contrast jitter. No
rotation/translation jitter, unlike `spotlight_pose2d.augment` -- keeps
...
same as `spotlight_pose2d`'s own horizontal-only flip is for its leg
...
`spotlight_pose2d`'s left/right leg pairs, there's no keypoint identity to
relabel.
"""
