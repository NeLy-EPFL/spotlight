#!/bin/bash -l
# Runs v9's TinyOrientModel checkpoint over one full validation trial
...
CHECKPOINT_PATH_REL="bulk_data/motion_prior/orient_model/checkpoints/v9/best.pt"
KEYPOINT_SET=neck
VIZ_CRF=23
MAX_VIZ_FRAMES=3000
...
predictions_h5="$output_dir/${TRIAL_STEM}_orient_predictions_v9.h5"
viz_path="$output_dir/${TRIAL_STEM}_orient_viz_v9.mp4"
