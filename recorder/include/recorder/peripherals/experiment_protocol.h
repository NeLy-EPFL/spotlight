...
inline const char *CMDSTR_SET_BEHAVIOR_EXPOSURE_TIME =
    ">SET_BEHAVIOR_EXPOSURE_TIME";
inline const char *CMDSTR_SET_MUSCLE_LIGHT_ON_TIME =
    ">SET_MUSCLE_LIGHT_ON_TIME";
inline const char *CMDSTR_SET_BEHAVIOR_FPS = ">SET_BEHAVIOR_FPS";
inline const char *CMDSTR_SET_SYNC_RATIO = ">SET_SYNC_RATIO";
inline const char *CMDSTR_SET_NUM_BEHAVIOR_TO_MUSCLE_LEADING_CYCLES =
    ">SET_NUM_BEHAVIOR_TO_MUSCLE_LEADING_CYCLES";
inline const char *CMDSTR_SET_MUSCLE_CAM_TRIGGER_DELAY =
    ">SET_MUSCLE_CAM_TRIGGER_DELAY";
inline const char *CMDSTR_START_RECORDING = ">START_RECORDING";
inline const char *CMDSTR_STOP_RECORDING = ">STOP_RECORDING";

const int CMDLEN_SET_BEHAVIOR_EXPOSURE_TIME =
    strlen(CMDSTR_SET_BEHAVIOR_EXPOSURE_TIME);
const int CMDLEN_SET_MUSCLE_LIGHT_ON_TIME =
    strlen(CMDSTR_SET_MUSCLE_LIGHT_ON_TIME);
...
const int CMDLEN_SET_NUM_BEHAVIOR_TO_MUSCLE_LEADING_CYCLES =
    strlen(CMDSTR_SET_NUM_BEHAVIOR_TO_MUSCLE_LEADING_CYCLES);
const int CMDLEN_SET_MUSCLE_CAM_TRIGGER_DELAY =
    strlen(CMDSTR_SET_MUSCLE_CAM_TRIGGER_DELAY);
