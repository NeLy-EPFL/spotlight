...
The closed-loop control and recording programs implemented in C++. A set of offline tools for calibration, postprocessing, etc. is implemented in Python and lives in [`tools/`](tools/). The C++ codebase contains three parts:
...
- [Architecture overview](docs/architecture.md): threads, cameras, and the trigger microcontroller.
